...
public class StudentController {
    ...
    public StudentController() {
        s[0] = new Student("1학년 1학기", "디지털콘텐츠이해", 3, 4.0, "A");
        s[1] = new Student("1학년 1학기", "실용영어", 2, 3.5, "B+");
        s[2] = new Student("1학년 2학기", "미디어커뮤니케이션", 3, 3.5, "B+");
...
//        s[10] = new Student("3학년 2학기", "소프트웨어공학", 3, 4.0, "A");
...
//        s[14] = new Student("4학년 2학기", "자바프로그래밍", 3, 4.0, "A");
